...
export const projects = [
    {
        id: 1,
        code: 'medly',
        name: 'Lifestyle Medly',
        description: 'A full-stack website designed and developed for a telehealth weight loss clinic based in New Jersey. *ONGOING*',
        screenshots: [
            '/medly/medly_main.png',
            '/medly/medly_steps.png',
            '/medly/medly_pricing.png',
            '/medly/medly_form.png',
            '/medly/medly_select.png',
        ],
        website: 'https://www.lifestylemedly.com/',
        github: 'https://github.com/mtojong246/lifestyle-medly',
        frontend: 'Next',
        backend: 'Firebase',
        styles: 'Tailwind',
        language: 'Typescript',
