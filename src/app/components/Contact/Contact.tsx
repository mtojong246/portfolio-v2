                ...
                <div className="w-full">
                    ...
                    <div className='text-[28px] font-medium'>
                        ...
                        <p className='ml-[35px] sm:ml-[70px] text-white'>
                            ...
                            <span className='text-[#1AFFC9]'><a href='https://github.com/mtojong246' target='_blank' rel="noopener noreferrer">[social_link_2]</a></span>
                            <span className='text-[#CCC9EC]'>,</span>
                        </p>
                        <p className='ml-[35px] sm:ml-[70px] text-white'>
                            <span className='text-[#CCC9EC]'>instagram: </span>
                            <span className='text-[#1AFFC9]'><a href='https://www.instagram.com/memelxox/?hl=en' target='_blank' rel="noopener noreferrer">[social_link_3]</a></span>
                            <span className='text-[#CCC9EC]'>,</span>
                        </p>
                        <div className='w-full h-[20px]'></div>
