                    ...
                    <div className='text-[28px] font-medium'>
                        ...
                        {socials.map(social => (
                            <AnimationOnScroll animateIn="animate__fadeInUp" animateOnce={true} delay={social.delay} key={social.id}>
                                <a href={social.link} target={social.target} rel={social.rel} className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-indigo-600 rounded-full shadow-md group">
