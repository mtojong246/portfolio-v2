                    ...
                    <div className='w-full'>
                        ...
                        {projects.map(project => (
                            <AnimationOnScroll animateIn="animate__fadeInUp" animateOnce={true} delay={project.delay} key={project.id}>
                                <div className='relative project group w-full cursor-pointer'>
                                    <img src={project.screenshots[0]} className='object-cover w-full' />
                                    <div className='absolute bottom-0 z-10 transition-all ease-in-out duration-500 opacity-0 group-hover:opacity-100 bg-white w-full h-full flex flex-col justify-between items-center py-10 md:py-5 px-5'>
